...
export const company = {
  name: 'Lumina Logic Studio',
  legalName: 'PT Lumina Logic Studio',
  tagline: 'Professional Software, Web, and Digital Solution Studio',
  shortTagline: 'Software • Website • Digital Solution',
  description:
    'PT Lumina Logic Studio is a technology studio focused on building professional websites, business software, and digital solutions that help companies improve their digital presence and operational efficiency.',
  email: 'luminalogicstudio@proton.me',
  phone: '',
  whatsapp: '',
  address: 'Indonesia',
  founded: '2026',
...
export const appPrivacyPolicies = [
  {
    ...
    status: 'Preparation',
    description:
      'Application privacy policies published by PT Lumina Logic Studio will be listed here once available.'
  }
];
